...
#-------------------------------------------------------------------------------------------------------------------- 
#-------------------------------------------------------------------------------------------------------------------- 
if not os.path.exists("bounding_boxes_images_result"):
        os.mkdir("bounding_boxes_images_result")
   # crp_cnt = 0
...
#-------------------------------------------------------------------------------------------------------------------- 
#-------------------------------------------------------------------------------------------------------------------- 
def save(im0,xyxy,counter):
  bb=im0[int(xyxy[1]):int(xyxy[3]),int(xyxy[0]):int(xyxy[2])]  #Image of the bounding box
  path="bounding_boxes_images_result"
  bb_resized=cv2.resize(bb,(224,224)) # You can apply some cv to img like resize, grayscale etc.
  b=cv2.imwrite(os.path.join(path,f"image{counter}.jpg"),bb_resized)
#-------------------------------------------------------------------------------------------------------------------- 
#--------------------------------------------------------------------------------------------------------------------  
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        save(im0,xyxy,counter)                       # Using save function---------------------------------------------------
